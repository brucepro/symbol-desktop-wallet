...
export const transactionTypeToIcon = {
  ...
  [TransactionType.VRF_KEY_LINK]: officialIcons.publicChain,
  [TransactionType.VOTING_KEY_LINK]: officialIcons.publicChain,
  [TransactionType.NODE_KEY_LINK]: officialIcons.publicChain,
